...
namespace OnePulse.App.Cli.Commands.Auth
{
    ...
    {
        public readonly Option<string> UserNameOption = new(name: "--user-name")
        {
            Description = "The user name for login.",
            Required = true,
        };
        public readonly Option<string> PasswordOption = new(name: "--password")
        {
            Description = "The password for login.",
            Required = true,
        };
        public readonly Option<string> UuidOption = new(name: "--uuid")
        {
        ...
        public readonly Option<string> DeviceOption = new(name: "--device")
        {
            Description = "The Device for login. (e.g., Xiaomi:17)",
            Required = false,
        };

        public readonly Option<bool> ReplaceOption = new(name: "--replace")
        {
